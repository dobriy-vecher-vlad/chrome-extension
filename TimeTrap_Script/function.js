							...
							document.querySelector('.script__text.settings__').innerHTML = `
								...
								<div class="settings__body">
									<div data-text='Отображаемые блоки'>
										...
										<input type="checkbox" id="_3" ${script__settings[name]._3 == true ? 'checked' : ''}><label for="_3">Улучшения клана<span>Блок с улучшениями клана пользователя</span></label>
										...
										<input type="checkbox" id="_5" ${script__settings[name]._5 == true ? 'checked' : ''}><label for="_5">Характеристики игрока<span>Блок с характеристиками пользователя</span></label>
									</div>
								</div>
								<div class="settings__body">
									<div data-text='Сортировка состава'>
										<input name="_6" type="radio" id="_6_1" value="1" ${script__settings[name]._6 == 1 ? 'checked' : ''}><label for="_6_1">Ранг<span>От главы до рядового</span></label>
										<input name="_6" type="radio" id="_6_2" value="2" ${script__settings[name]._6 == 2 ? 'checked' : ''}><label for="_6_2">Урон<span>От большего к меньшему</span></label>
										<input name="_6" type="radio" id="_6_3" value="3" ${script__settings[name]._6 == 3 ? 'checked' : ''}><label for="_6_3">Экипировка<span>От большего к меньшему</span></label>
										<input name="_6" type="radio" id="_6_4" value="4" ${script__settings[name]._6 == 4 ? 'checked' : ''}><label for="_6_4">Дата первого входа<span>От новой к старой</span></label>
									</div>
								</div>
							`;
